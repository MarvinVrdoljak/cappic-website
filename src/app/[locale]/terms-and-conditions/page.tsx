    ...
    <>
      {locale === 'de' && (
        <>
          ...
          <p>
            ...
            <br />
            „Inhalte“ bezeichnet alle durch Nutzer:innen erstellten oder hochgeladenen Bilder, Texte
            oder sonstige Daten.
            <br />
          ...
          <h3>4.3 Verhalten</h3>
          <p>
            Nutzer:innen verpflichten sich, respektvoll mit anderen zu kommunizieren. Beleidigende,
            belästigende oder irreführende Inhalte sind untersagt.
          </p>
          ...
          <p>
            Die Teilnahme an Challenges erfolgt auf eigene Gefahr. Wir haften nicht für Verletzungen
            oder Schäden, die durch die Teilnahme entstehen.
          </p>
          ...
          <p>
            ...
            Nutzer:innen stimmen zu, dass personenbezogene Daten zur Vertragsabwicklung gespeichert
          ...
          <p>
            ...
            Sitz des Anbieters, sofern es sich bei dem Nutzer um eine juristische Person oder einen
            Kaufmann handelt.
          </p>
        </>
      )}
      {locale === 'en' && (
        <>
          ...
          <p>
            Using the app requires registration, including the full name and a valid email address.
          </p>
          ...
          <p>
            You may upload your own content (e.g., photos) as long as it does not violate applicable
            laws or these T&C.
          </p>
          ...
          <h3>4.3 Conduct</h3>
          <p>
            Users must communicate respectfully. Offensive, harassing, or misleading content is not
            allowed.
          </p>
          ...
          <p>
            We are only liable for damages caused by intentional or gross negligence. Liability for
            simple negligence is excluded unless essential contractual obligations are breached.
          </p>

          <h3>6.5 Disclaimer for App Usage</h3>
          <p>
            Using the "cappic" app and participating in challenges is at your own risk. We assume no
            liability for injuries, damages, or other negative consequences resulting from app usage
            or challenge participation.
          </p>
          <p>
            Users must ensure their own safety and the safety of others at all times. Challenges are
            intended for entertainment and should only be performed within personal capabilities and
          ...
          <p>
            ...
            of Goods (CISG).
            <br />
            The place of jurisdiction for disputes related to these T&C is the registered office of
            the provider, if the user is a legal entity or merchant.
          </p>
        </>
      )}
    </>
