      ...
      {locale === 'de' && (
        <>
          ...
          <p>
            ...
            deiner personenbezogenen Daten ist uns ein wichtiges Anliegen. Im Folgenden informieren
            wir dich über die Verarbeitung deiner Daten gemäß der Datenschutz-Grundverordnung
            (DSGVO).
          </p>
          <h2>1. Verantwortliche Stelle</h2>
          <p>
            Verantwortlich für die Datenverarbeitung im Rahmen der Nutzung der App und Webseite ist:
          </p>
          <p>
            Marvin Vrdoljak
            <br />
          ...
          <ul>
            <li>
              Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung): Verarbeitung, die für die Nutzung der
          ...
          <p>
            ...
            <br />
            Nach einer Löschung des Kontos werden alle personenbezogenen Daten vollständig entfernt.
            <br />
          ...
          <ul>
            ...
            <li>IP-Anonymisierung: Google Analytics speichert keine vollständigen IP-Adressen.</li>
            <li>
            ...
            <li>
              Deaktivierungsmöglichkeit: Tracking kann jederzeit über die Cookie-Einstellungen oder
              Browser-Plugins deaktiviert werden.
            </li>
          </ul>
          ...
          <p>
            ...
            <br />
            Eltern und Erziehungsberechtigte sind verantwortlich für die Nutzung durch minderjährige
            Personen.
          </p>
          ...
          <p>
            ...
            Anforderungen oder App-Funktionen zu berücksichtigen. Die aktuelle Version ist jederzeit
            auf unserer Webseite abrufbar.
          </p>
          <h2>12. Allgemeine Geschäftsbedingungen (AGB)</h2>
          <p>
            Die Nutzung der App „cappic“ unterliegt unseren Allgemeinen Geschäftsbedingungen (AGB).
            <br />
      ...
      {locale === 'en' && (
        <>
          ...
          <p>
            ...
            <br />
            Order data (photo book purchases) is stored for at least six years due to tax and legal
          ...
          <ul>
            ...
            <li>
              Collected data: Visited pages, time spent, device information, truncated IP addresses.
            </li>
            <li>
          ...
          <p>
            Order data (items, prices, billing details) is stored for at least six years for tax and
            legal reasons.
            <br />
